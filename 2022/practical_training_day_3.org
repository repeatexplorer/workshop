...
# check um can be found on miniconda ducumantation : https://docs.conda.io/en/latest/miniconda.html
#+end_src
...
singularity imag is available in https://github.com/repeatexplorer/repex_tarean/releases
#+begin_src bash :tangle day3_commands.sh
...
** Data:
Get data and check the quality of reads:
#+begin_src bash :tangle day3_commands.sh
...
Use Trimmomatic program to remove low quality reads and trim end2. Trimmomatic will be used in Pair-end mode. 
...
** make FASTQ interleaved file and convert to FASTA
#+begin_src bash :tangle day3_commands.sh
...
#+begin_src bash :tangle day3_commands.sh
# get data fro comparative analysis
cd ~/repeatexplorer
mkdir comparative
cd comparative
...
#+begin_src bash :tangle day3_commands.sh
seqtk mergepe SRR089356_1_clean_sample.fastq SRR089356_2_clean_sample.fastq seqtk  > SRR089356_clean_sample_merged.fastq
seqtk mergepe SRR089356_1_clean_sample.fastq SRR9938304_2_clean_sample.fastq seqtk  > SRR9938304_clean_sample_merged.fastq
# convert to FASTA
seqtk seq -A SRR089356_clean_sample_merged.fastq > SRR089356_clean_sample_merged.fasta
